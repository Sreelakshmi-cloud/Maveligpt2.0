...
def Maveli():
    ...
    while True:
        ...
        elif user_input == "ethra divasathe aaghosham aanu onam?" or user_input == "onam is celebrated in how many days" or "days" in user_input or "divasam" in user_input or user_input == "number of days" or user_input == "divasangal":
            print("Maveli: Onam 10 divasam neenda aaghosham aanu.")

        elif user_input == "onakkaalathu keralathilekkulla maaveliyude vaarshika thirichuvaravinte prasakthi enthaanu" or "return of maveli to Kerala" in user_input or "thirichuvaravu" in user_input or "Keralam" in user_input:
            print("Maveli: Maveliyude Keralathilek ulla vaarshika thirichuvaravu aalukalkku avarude aadarshangalodum abhilaashangalodum veendum bandhappedaanulla oru maargamaayi kaanavunnathaanu. Onam polulla ulsavangal samuhangale nyaayam, aikyam, samrudhi thudangiya moolyangalil koottaayi prathifalippikkan sahaayikkunnu, prathyaashayudeyum naveekaranathinteyum bodham valarthunnu. Vyakthiparavum saamudaayikavumaaya jeevithathil unnamanathinaayi parisramikkan aalukale prolsahippikkunna, bhoothakaalavumaayulla puthukkalinteyum punerbandhanathinteyum chakrangalude maanushika aavashyakathaye pratheekappeduthunnu maaveliyude thirichuvaravu. Thaalkaalikamaayi nashtappettaalum neethiyudeyum aikyathinteyum aadarshangal ekaalavum veendedukkanaakumenna aashayathe ithu shakthippeduthunnu. ")
        ...
        elif "story of onam" in user_input or "legend of onam" in user_input or "ithihasam" in user_input or "aithihyam" in user_input:
